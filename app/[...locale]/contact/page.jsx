...
const baseUrl = "https://blackmaps.com.ar";
    ...
    return {
        ...
        keywords: [t('kw0'), "Twitter", "BlackMaps", t('kw3'), t('kw4'), t('kw5'), t('kw6')],
        openGraph: {
            title: t('meta_title'),
            description: t('meta_description'),
            ...
            <main className="bg-white dark:bg-neutral-900 pt-20">
                <div className="container px-6 py-12 mx-auto">
                    <div>
                        ...
                        <h1 className="mt-2 text-4xl font-bold text-neutral-800 md:text-6xl dark:text-white">{t("title")}</h1>

                        <p className="mt-3 text-neutral-500 dark:text-neutral-400">{t("subtitle")}.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                            <div className="mx-auto text-center md:mx-0">
                                ...
                                <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">{t('email_data')}</p>
                            ...
                            <div className="mx-auto text-center md:mx-0">
                                ...
                                <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">{t('tw_data')}</p>
...
M19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                                ...
                                <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">{t('ig_data')}</p>
                            ...
                            <div className="mx-auto text-center md:mx-0">
                                ...
                                <h2 className="mt-4 text-base font-medium text-neutral-800 dark:text-white">{t('perig')}</h2>
                                <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">{t('perig_data')}</p>
