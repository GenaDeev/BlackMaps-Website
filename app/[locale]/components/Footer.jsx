      ...
      <footer className="bg-[#ccc] dark:bg-[#242424]">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0 flex gap-3 items-center">
              <Link
                ...
                href="/"
                className="hover:scale-95 transition duration-200 flex items-center"
              >
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm sm:text-xs  sm:text-center dark:text-white">
              © 2024{" "}
              <Link href="/" className="hover:underline">
                BlackMaps™
              </Link>{" "}
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a
                title={t("icon_sr_twitch")}
                href="https://www.twitch.tv/mapsblack/"
                className="hover:text-gray-500 text-gray-900 dark:text-white dark:hover:text-gray-500"
              >
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
                ...
                >
                  <path
                    fill="currentColor"
                    d="M2 0 1 4v17h5v3h3l4-3h4l6-6V0H2zm19 14-3 3h-6l-3 3v-3H4V2h17v12zm-3-8v7h-2V6h2zm-6 0v7h-2V6h2z"
                    fillRule="evenodd"
                    clipRule="evenodd"
                  />
                </svg>
              ...
              <a
                title={t("icon_sr_ig")}
                href="https://www.instagram.com/maps_black/"
