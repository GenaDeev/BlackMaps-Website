                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">{t('sections_title')}</h2>
                                <ul className="font-medium flex flex-col gap-4">
                                    <li>
                                        <Link href="/" className="hover:underline">{t('sections_home')}</Link>
                                    </li>
                                    <li>
                                        <a href="#about" className="hover:underline">{t('sections_history')}</a>
                                    </li>
                                    <li>
                                        <Link href="/maps" className="hover:underline">{t('sections_maps')}</Link>
                                    </li>
                                    <li>
                                        <Link href="/contact" className="hover:underline">{t('sections_contact')}</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">{t('dev_title')}</h2>
                                <ul className="font-medium flex flex-col gap-4">
                                    <li>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            <a title={t('icon_sr_twitch')} href="https://www.twitch.tv/mapsblack/" className="hover:text-gray-500 text-gray-900 dark:text-white dark:hover:text-gray-500">
                                ...
                                <span className="sr-only">{t('icon_sr_twitch')}</span>
                            </a>
                            <a title={t('icon_sr_ig')} href="https://www.instagram.com/maps_black/" className="hover:text-gray-500 text-gray-900 dark:text-white dark:hover:text-gray-500 ms-5">
                                ...
                                <span className="sr-only">{t('icon_sr_ig')}</span>
                            </a>
                            <a title={t('icon_sr_twitter')} href="https://x.com/maps_black/" className="hover:text-gray-500 text-gray-900 dark:text-white dark:hover:text-gray-500 ms-5">
                                ...
                                <span className="sr-only">{t('icon_sr_twitter')}</span>
                            </a>
                            <a title={t('icon_sr_git')} href="https://github.com/GenaAaaj/BlackMaps-Website/" className="hover:text-gray-500 text-gray-900 dark:text-white dark:hover:text-gray-500 ms-5">
                                ...
                                <span className="sr-only">{t('icon_sr_git')}</span>
                            </a>
                            <a title={t('icon_sr_mail')} href="mailto:maps.black8@gmail.com" className="hover:text-gray-500 text-gray-900 dark:text-white dark:hover:text-gray-500 ms-5">
                                ...
                                <span className="sr-only">{t('icon_sr_mail')}</span>
                            </a>
                        </div>
                    </div>
                </div>
