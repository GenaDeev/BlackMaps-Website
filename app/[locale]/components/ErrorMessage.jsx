export default function ErrorMessage(props) {
  ...
  return (
    <div
      className={
        type === "warning"
          ? "bg-orange-600/30 p-8 flex flex-col sm:flex-row items-center gap-6 rounded-xl m-8"
          : type === "error"
          ? "bg-red-600/30 p-8 flex flex-col sm:flex-row items-center gap-6 rounded-xl m-8 max-w-[1114px]"
          : type === "minor" &&
            "bg-blue-600/30 p-8 flex flex-col sm:flex-row items-center gap-6 rounded-xl m-8 max-w-[1114px]"
      }
    >
      ...
      <div className="error-message flex flex-col gap-4 text-md sm:text-lg md:text-xl">
        ...
        <a
          ...
          className="italic opacity-60 hover:opacity-100 transition duration-200"
        >
          GenaDev
        </a>
      </div>
