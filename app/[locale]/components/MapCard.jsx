        ...
        >
            ...
            <div className="p-5 flex flex-col justify-between">
                <div>
                    ...
                    <a href={tweet}>
                        <h5
                            className="mb-2 text-2xl line-clamp-3 font-bold tracking-tight text-ellipsis overflow-hidden max-h-[100px] text-gray-900 dark:text-white"
                        >
                            {title}
                        </h5>
                ...
                <div className="flex w-full justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <span title={likes + ' likes'} className="h-[36px] px-2 text-sm cursor-pointer rounded-full dark:bg-[#2d2d2d] bg-[#aaa] flex gap-2 items-center">
                            <svg width="24px" height="24px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" d="M19.285 12.645a3.8 3.8 0 0 0-5.416-5.332q-.288.288-.732.707l-.823.775l-.823-.775q-.445-.42-.733-.707a3.8 3.8 0 0 0-5.374 0c-1.468 1.469-1.485 3.844-.054 5.32l6.984 6.984l6.97-6.972zm-14.75-6.18a5 5 0 0 1 7.072 0q.273.274.707.682q.432-.408.707-.683a5 5 0 0 1 7.125 7.017l-7.125 7.126a1 1 0 0 1-1.414 0L4.48 13.48a5 5 0 0 1 .055-7.017z"></path></svg>{!likes ? "0" : likes}
                        </span>
                        <span
