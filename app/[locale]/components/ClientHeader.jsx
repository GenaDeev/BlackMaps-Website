      ...
      <ul className="flex gap-3">
        <li>
          <button
            ...
            className={
              "w-12 h-12 flex items-center justify-center sm:hover:scale-105 active:scale-95 transition rounded-xl p-2 " +
              (colorScheme === "dark"
        ...
        <li>
          <div className="langselect gap-1 flex w-12 h-12 sm:w-auto items-center justify-center sm:hover:scale-105 active:scale-95 transition dark:text-white text-[#1d1d1d] active:bg-[#bbb] dark:active:bg-[#2d2d2d] dark:bg-[#4d4d4d] bg-[#aaa] rounded-xl p-2 font-bold">
            ...
            <select
              aria-label="Language"
              className="hidden sm:block pb-[1px] bg-transparent rounded-xl outline-none h-full"
            ...
            <select
              aria-label="Language"
              className="sm:hidden text-xl block bg-transparent rounded-xl outline-none h-full"
              onChange={handleChange}
              value={currentLocale}
            >
        ...
        <li style={mapsLinkStyle}>
          <Link
            href={lang === "en" ? "/en/maps" : "/maps"}
            title={lang === "en" ? "Map Gallery" : "Galeria de Mapas"}
            aria-label={lang === "en" ? "Map Gallery" : "Galeria de Mapas"}
            className="gap-2 flex w-12 h-12 sm:w-auto items-center justify-center sm:hover:scale-105 active:scale-95 transition dark:text-white text-[#1d1d1d] active:bg-[#bbb] dark:active:bg-[#2d2d2d] dark:bg-[#4d4d4d] bg-[#aaa] rounded-xl p-2 font-bold"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
        ...
        <li style={contactLinkStyle}>
          <Link
            ...
            title={lang === "en" ? "Contact form" : "Formulario de contacto"}
            aria-label={
        ...
        <li>
          <Link
            ...
            title={lang === "en" ? "Twitter account" : "Cuenta de Twitter"}
            aria-label={lang === "en" ? "Twitter account" : "Cuenta de Twitter"}
            className="gap-2 flex w-12 h-12 sm:w-auto items-center justify-center sm:hover:scale-105 active:scale-95 transition dark:text-white text-[#1d1d1d] active:bg-[#bbb] dark:active:bg-[#2d2d2d] dark:bg-[#4d4d4d] bg-[#aaa] rounded-xl p-2 font-bold"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
