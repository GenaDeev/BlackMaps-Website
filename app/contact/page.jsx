        ...
        <section className="bg-white dark:bg-neutral-900 pt-20">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    ...
                    <p className="mt-3 text-neutral-500 dark:text-neutral-400">Para nosotros, tu opinion es lo mas importante. No dudes en dejar tus dudas o consultas en este formulario o escribiendo atraves de nuestros canales de contacto.</p>
                </div>

                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        <div className="mx-auto text-center md:mx-0 text-left">
                            ...
                            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">Correo electronico oficial de BlackMaps.</p>
