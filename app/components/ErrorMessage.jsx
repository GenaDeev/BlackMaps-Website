...
export default function ErrorMessage(props) {
    ...
    return (
        <div className={type === "warning" ? "bg-orange-600/30 p-8 flex flex-col sm:flex-row items-center gap-6 rounded-xl m-8" : "bg-red-600/30 p-8 flex flex-col sm:flex-row items-center gap-6 rounded-xl m-8"}>
