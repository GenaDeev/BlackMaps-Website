            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <a title="Instagram" href="https://www.instagram.com/maps_black/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                        ...
                        <a title="Twitter" href="https://x.com/maps_black/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                        ...
                        <a title="GitHub" href="https://github.com/GenaAaaj/BlackMaps-Website/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                        ...
                        <a title="E-Mail" href="mailto:maps.black8@gmail.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
